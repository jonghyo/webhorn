...
function AudioVisualizer() {
  ...
  // visualizer cosmetic properties
  this.opacity = 1;
  this.color = null;
  ...
  // generate web audio api and creates svg container for visualizer
  ...
  // creates all the visualizer elements to be manipulated and sets up audio connects and
  // freq data array
  ...
  // stops visualizer bars in place
  this.pause = function() {
  ...
  // stops the visualizer bars by making them all 0
  ...
  // clears the visualizer from DOM. no current way to instantiate
